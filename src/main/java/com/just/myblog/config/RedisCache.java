...
public class RedisCache implements Cache {
    ...
    //生成key
    private final String COMMON_CACHE_KEY = "com:just:blog:";
//    @Autowired
//    private  RedisUtils redisUtils;//redis工具库
...
//            redisUtils.set( getKey(key), value, EXPRIRE_TIME_IN_MINUT*60);
...
//        Set<String> keys = redisUtils.getKeys(getKeys());
//        redisUtils.deleteSet(keys);
